...
if __name__ == '__main__':
    ...
    folder = "C:\\Users\\oabdu\\ML_Project\\train_val\\train_val"
    ...
    for i in range(num_images):
        ...
        if os.path.isfile(filepath_mask):
            ...
            if not cv2.imwrite(folder +r'\\OutputMasks\\' + prefix + '_CLAHE.bmp', img):
        ...
        if os.path.isfile(filepath):
            ...
            if not cv2.imwrite(folder +r'\\OutputImages\\' + prefix + '_CLAHE.jpg', preprocess_img):
               raise Exception("Could not write image")
            #cv2.imwrite('OutputImages/' + prefix + '_CLAHE.jpg', preprocess_img)
            #cv2.imwrite(folder +'\\Temps\\' + prefix + '_CLAHE.jpg', preprocess_img)
